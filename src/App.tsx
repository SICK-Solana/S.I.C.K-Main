...
export default function Component() {
  return (
    <>
    <div className=" min-h-screen justify-center items-center bg-gradient-to-br from-gray-900 to-gray-800 text-white relative overflow-hidden" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div className="container mx-auto px-4 py-8 relative z-10 ">
        <header className="flex justify-between items-center mb-28">
          ...
          <Button variant="outline" className="text-black bg-white rounded-2xl">
        ...
        <main className="text-center mb-16 justify-center items-center">
          ...
          <Button
  className="text-gray-900 px-10 py-8 rounded-full text-lg bg-gradient-to-b from-lime-400 to-lime-800  shadow-[0_8px_24px_rgba(255,255,0,0.6)] hover:shadow-[0_12px_24px_rgba(255,255,0,0.8)] transition-shadow duration-300"
>
  Get Started
</Button>
